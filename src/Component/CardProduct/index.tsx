  ...
  const classes = useStyles();
        ...
        return (
          <Card className={classes.root} key={id}>
            ...
            <CardContent sx={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between', rowGap:1}}>
              ...
              <Typography  variant='body1' color='primary' component='p'>{price}$</Typography>
            </CardContent>
          </Card>
        );
};
